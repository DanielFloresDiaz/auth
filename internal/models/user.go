...
func IsDuplicatedEmail(tx *storage.Connection, email, aud string, currentUser *User, ownDomainProviders []string, organization_id uuid.UUID, project_id uuid.UUID) (*User, error) {
