...
-- Grant usage permissions to solomon_auth_user_role
...
ALTER ROLE solomon_auth_user_role SET search_path TO auth;
ALTER ROLE solomon_auth_admin_role SET search_path TO auth;
ALTER ROLE rl_auth_user_role SET search_path TO auth;
...
-- GRANT solomon_auth_user_role TO solomon_user;
